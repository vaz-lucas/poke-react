    ...
    return (
        ...
        <div className={isFavorite ? 'favoritePokemons favStar pokemon-preview' : "pokemon-preview"} id={id}>
            <div className="display-pokemon">
                ...
                <button className={`star ${isFavorite ? 'favoritePokemons' : ''}`} onClick={handleFavorite}><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
